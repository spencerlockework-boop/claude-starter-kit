...
echo "  - docs/architecture.md          (stable blueprint — update only when architecture actually changes)"
echo "  - docs/architecture-review.md   (point-in-time PR/fix plan — regenerate after audits, in fresh session)"
